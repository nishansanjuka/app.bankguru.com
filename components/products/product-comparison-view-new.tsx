      ...
      <DialogContent className="max-w-[95vw] max-h-[85vh] p-0">
        <DialogHeader className="p-4 pb-0">
          <DialogTitle className="flex items-center justify-between">
            <span className="text-lg font-semibold">Product Comparison</span>
          ...
          <div className="p-4 pt-0">
            ...
            <div className="grid gap-4" style={{ gridTemplateColumns: `200px repeat(${products.length}, 1fr)` }}>
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2 mb-2">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {product.isFeatured && (
                          <Badge className="bg-orange-100 text-orange-700 text-xs h-4 mt-1">
                    ...
                    {/* Product Image */}
                    {productImage && (
                      <div className="relative w-full h-16 mb-2 rounded overflow-hidden bg-gray-50">
                        <Image
              ...
              <div className="col-span-full mt-4">
                <h3 className="text-sm font-semibold text-gray-900 mb-3 px-2">Basic Information</h3>
              </div>
              ...
              {products.some((p) =>
                ...
                <>
                  <div className="col-span-full mt-4">
                    ...
                    <h3 className="text-sm font-semibold text-gray-900 mb-3 px-2">Additional Features</h3>
                  </div>
